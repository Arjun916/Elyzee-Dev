<?php
    ...
    $t['no_such_user'] = 'If an account exists with the provided username or email, you will receive a confirmation link shortly.<br/>Please check your email inbox.';
