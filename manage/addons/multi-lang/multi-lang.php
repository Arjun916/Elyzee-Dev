    ...
    if ( !defined('K_COUCH_DIR') ) die(); // cannot be loaded directly
        ...
        class MultiLang{
            ...
            function __construct(){
                ...
                $FUNCS->add_event_listener( 'funcs_get_link', array($this, 'funcs_get_link') );
                $FUNCS->add_event_listener( 'cart_get_template_link', array($this, 'funcs_get_link') );
                $FUNCS->add_event_listener( 'cart_get_item_link', array($this, 'funcs_get_link') );
            ...
            function funcs_get_link( $masterpage, &$link ){
                $masterpage = trim( $masterpage );
                if( $masterpage=='' ){ return; }

                if( !in_array($masterpage, $this->exclude_templates) ){
                    $link = $this->_add_lc( $link );
                }
            }
