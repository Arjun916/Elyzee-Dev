...
class TinyHtmlMinifier
{
    ...
    // Run minifier
    public function tiny_minify(string $html) : string
    {
    ...
    private function compact($content, $name, $element)
    {
        ...
        if (in_array($name, $this->elements['skip'])) {
            ...
            $this->head) {
            return $this->tiny_minifyHard($content);
        } else {
            return $this->tiny_minifyKeepSpaces($content);
        }
    }
    ...
    private function tiny_minifyHard($element)
    {
        $element = preg_replace('!\s+!', ' ', $element);
    ...
    private function tiny_minifyKeepSpaces($element)
    {
