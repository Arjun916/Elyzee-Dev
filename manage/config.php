<?php
    ...
    define( 'K_SITE_URL', 'https://www.elyzee.ae/' );
    ...
    define( 'K_DB_NAME', 'elyzee_webdb' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'elyzee_root' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'Elyzee@098765#567890%' );
    // 7.
    ...
    define( 'K_DB_TABLES_PREFIX', 'elyzee_' );
    ...
    define( 'K_RECAPTCHA_SITE_KEY', '6LfIfO0rAAAAAEaQCJxfpP5ldWArWXsk5degOeH8' );
    define( 'K_RECAPTCHA_SECRET_KEY', '6LfIfO0rAAAAAHeUMfHrVC219_iZjr8XunvlNwh8' );
    ...
    define( 'K_ADMIN_FOOTER', '<a href="https://www.elyzee.ae/" title="Elyzee Hospital, Abu Dhabi, UAE">Elyzee Hospital, Abu Dhabi, UAE</a>' );
    ...
    //<a href="https://www.elyzee.ae/" title="Elyzee Hospital, Abu Dhabi, UAE">Elyzee Hospital, Abu Dhabi, UAE</a></div>
    //
